                                ...
                                <div class= "d-flex justify-content-center ;">
                                    <div class="card text-bg-dark" id="borda">
                                        <div class="card-body" style="overflow: hidden;">
                                          <p class="card-text" id="texto" style="text-align: center;">
                                          Inspirando sonhos, o projeto SALVE<br> é a força que impulsiona jovens<br> das periferias a conquistarem seus objetivos, <br>criando oportunidades e quebrando barreiras para um futuro de <br>sucesso e realizações.</p>
                                        </div>
                                      </div>
                                  </div>
                                </div>
...
<!--Sessão projetos--> 
                                      ...
                                      <div class="col-md-6 mx-auto">
                                        <div id="carouselExampleIndicators" class="carousel slide w-100 float-right custom-carousel" data-ride="carousel">
                                            ...
                                            <div class="carousel-inner">
                                                <div class="carousel-item active">
                                                    <a href="projetos.html"><img class="d-block w-100" src="imgprojeto/pastoralmenor.png"  alt="Primeiro Slide" id="imgpastoral1"></a>
                                                </div>
                                                <div class="carousel-item">
                                                <a href="projetos.html"><img class="d-block w-100" src="imgprojeto/karate.png"  alt="Primeiro Slide" id="imgkarate1"></a>
                                                </div>
                                                <div class="carousel-item">
                                                <a href="projetos.html"><img class="d-block w-100" src="imgprojeto/jiu0.png"  alt="Primeiro Slide" id="imgjiu1"></a>
                                                </div>
                                                <div class="carousel-item">
                                                <a href="projetos.html"><img class="d-block w-100" src="imgprojeto/afissore.jpg"  alt="Primeiro Slide" id="afi1"></a>
                                                </div>
                                            </div>
                                              ...
                                              <div class="col-md-4 col-12" id="pessoa">
                                                  ...
                                                  <a href="https://www.instagram.com/___pradoo/"target="_blank">
                                                      ...
                                                      <div class="texto-sobre-imagem">
                                                          ...
                                                          20 anos<br>Responsável no desenvolvimento do Back e Front, e criação do banco de dados.
                                                      </div>
                                                  </div>
                                              </div>
                                              <div class="col-md-4 col-12" id="pessoa">
                                                  <div class="imagem-container"> 
                                                    <a href="https://www.instagram.com/k4uand/"target="_blank">
                                                      <img src="img/kauan1.jpeg" class="img-fluid" data-toggle="modal" id="imgpessoas" data-target="#myModal" style="width: 100%;">
                                                      </a>
                                                      <div class="texto-sobre-imagem">
                                                        <h4>Kauan Davi</h4><br>
                                    ...
                                    Entre em contato conosco...
                                      ...
                                      <div class="col-lg-3 col-md-6 mb-4">
                                        ...
                                        <div class="midias d-flex">
                                          ...
                                          <div id="zap"> <a href="http://www.whatsapp.com" target="_blank" id="zap1">
                                          ...
                                          <div id="insta"> <a href="https://www.instagram.com/salveacomunidade" target="_blank"id="ins1">
                                          ...
                                          <div id="email"> <a href="mailto:salveacomunidade015@gmail.com" text target="_blank"id="mail1">
